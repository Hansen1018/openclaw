...
| `openclaw.channel.setupCapabilities.invalidConfigRecovery`                                | Opts a trusted channel setup adapter into path-scoped recovery of its own invalid legacy config. Separate from install recovery.                                                       |
