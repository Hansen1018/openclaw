...
export const id: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      loggedOut: "Keluar.",
      logoutNotCleared:
        "Tidak ada sesi WhatsApp tersimpan yang dihapus. Mungkin sudah tidak ada, atau direktori autentikasinya perlu dibersihkan secara manual.",
    },
  ...
  configView: {
    ...
    sidebarPrefs: {
      title: "Bilah Samping",
      hint: "Pilih apa yang tampil saat sesi sedang berjalan.",
  ...
  custodian: {
    ...
    history: {
      ...
      invalidEdit: "Edit manual ini tidak lolos validasi konfigurasi.",
  ...
  mcpServers: {
    ...
    adminRequired: "Perubahan MCP server memerlukan akses operator.admin.",
    enable: "Aktifkan",
    disable: "Nonaktifkan",
  ...
  labsPage: {
    ...
    sectionDescription: "Perubahan tersimpan langsung dan berlaku untuk proses agen mendatang.",
  ...
  appsPage: {
    ...
    pairDevice: "Sambungkan perangkat Anda",
  ...
  board: {
    ...
    widget: {
      ...
      appStaleTitle: "App yang disematkan ini sudah usang",
      appStaleDetail: "Server, resource, atau transkrip asalnya tidak lagi tersedia.",
      retry: "Coba lagi",
      ...
      sandboxOriginRequired:
        "Otorisasi widget gagal setelah beberapa kali percobaan penyegaran. Jika gateway berjalan di belakang reverse proxy atau tunnel yang tidak merutekan port sandbox widget, setel mcp.apps.sandboxOrigin ke origin publik khusus yang dirutekan ke listener sandbox.",
  ...
  chat: {
    ...
    board: {
      ...
      dockLeft: "Dok obrolan ke kiri",
      dockRight: "Dok obrolan ke kanan",
      dockBottom: "Dok obrolan ke bawah",
      ...
      resetDescription: "Konteks percakapan akan disetel ulang. Dashboard Anda tetap ada.",
    },
    catalog: {
