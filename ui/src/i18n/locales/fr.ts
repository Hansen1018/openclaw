...
export const fr: TranslationMap = {
  ...
  labsPage: {
    intro:
      "Labs contient des fonctionnalités expérimentales susceptibles de changer, de ne plus fonctionner ou de disparaître entre les versions.",
  ...
  appsPage: {
    ...
    heroTagline:
      "Des applications compagnon pour votre téléphone, votre montre, votre ordinateur et votre navigateur — ainsi que des plugins pour étendre les capacités de votre agent.",
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "Discussions en un coup d'œil et réponses rapides depuis votre poignet.",
      },
      wearOs: {
        title: "Wear OS",
  ...
  board: {
    ...
    emptyTitle: "Un tableau vierge, prêt pour le travail",
