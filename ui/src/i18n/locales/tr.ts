...
export const tr: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      logoutNotCleared:
        "Kayıtlı bir WhatsApp oturumu temizlenmedi. Zaten yok olabilir veya kimlik doğrulama dizininin manuel olarak temizlenmesi gerekebilir.",
    },
  ...
  sessionsView: {
    ...
    waitingForAnswer: "Cevabınız bekleniyor",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeBlockedHint:
        "OpenClaw için bildirimler macOS'ta devre dışı. Bunları Sistem Ayarları > Bildirimler'den etkinleştirin.",
    },
    appearance: {
      theme: "Tema",
  ...
  subtitles: {
    ...
    security: "Gateway kimlik doğrulama, çalıştırma politikası, araç profili ve onaylar.",
  ...
  mcpServers: {
    ...
    nameInvalid: "Sunucu adları harf, rakam, nokta, tire veya alt çizgi içerebilir.",
  ...
  mcpPage: {
    connectorsLink: "Eklentiler sayfasında tek tıklamalık bağlayıcıları keşfedin.",
    servers: "Sunucular",
    oauth: "OAuth",
  ...
  sessionsPage: {
    hubTablistLabel: "Konu başlığı bölümleri",
  },
  pluginsPage: {
  ...
  labsPage: {
    ...
    codeMode: {
      title: "Code Mode",
      description:
        "Aracıların araçları kompakt, korumalı alandaki JavaScript iş akışlarında birleştirmesine izin verin.",
    },
    swarm: {
      title: "Swarm",
  ...
  appsPage: {
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "iOS üzerinden sohbet edin, konuşun, eylemleri onaylayın ve OpenClaw'a paylaşın.",
      },
      android: {
        title: "Android",
  ...
  board: {
    ...
    emptyTitle: "Boş bir pano, işe hazır",
    ...
    widget: {
      ...
      sandboxOriginRequired:
        "Tekrarlanan yenileme denemelerinden sonra widget yetkilendirmesi başarısız oldu. Gateway, widget sandbox portunu yönlendirmeyen bir ters proxy veya tünelin arkasında çalışıyorsa, mcp.apps.sandboxOrigin değerini sandbox dinleyicisine yönlendirilmiş özel bir genel kaynağa ayarlayın.",
  ...
  chat: {
    ...
    composer: {
      ...
      holdToRecordSettingDescription:
        "Besteci mikrofon düğmesini basılı tutun, konuşun, ardından metni göndermeden eklemek için bırakın.",
