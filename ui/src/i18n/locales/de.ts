...
export const de: TranslationMap = {
  ...
  configView: {
    ...
    sidebarPrefs: {
      ...
      liveActivity: "Live-Agent-Aktivität in der Seitenleiste anzeigen",
      liveActivityHint:
  ...
  custodian: {
    ...
    history: {
      ...
      description: "Was auf diesem System geändert wurde, neueste zuerst.",
  ...
  labsPage: {
    ...
    sectionDescription:
      "Änderungen werden sofort gespeichert und gelten für zukünftige Agentenläufe.",
  ...
  appsPage: {
    ...
    heroTagline:
      "Begleit-Apps für dein Telefon, deine Uhr, deinen Desktop und deinen Browser – plus Plugins, um zu erweitern, was dein Agent kann.",
    ...
    cards: {
      ...
      android: {
        title: "Android",
        desc: "Dein Android-Smartphone als vollwertiger OpenClaw-Knoten – Chat, Kamera und Canvas.",
      },
      appleWatch: {
        title: "Apple Watch",
      ...
      macos: {
        title: "macOS",
        desc: "Menüleisten-Begleit-App für dein Gateway – Benachrichtigungen, Freigaben, schneller Chat.",
      },
      windows: {
        title: "Windows",
  ...
  profilePage: {
    ...
    identity: {
      ...
      avatar: "Avatar",
      avatarDescription:
        "PNG, JPEG oder WebP. Bilder werden auf 256 × 256 oder kleiner verkleinert.",
      ...
      avatarErrors: {
        ...
        sourceTooLarge: "Wähle ein Bild mit maximal 10 MB.",
  ...
  board: {
    ...
    widget: {
      ...
      sandboxOriginRequired:
        "Widget-Autorisierung nach wiederholten Aktualisierungsversuchen fehlgeschlagen. Wenn das Gateway hinter einem Reverse-Proxy oder Tunnel läuft, der den Widget-Sandbox-Port nicht weiterleitet, setzen Sie mcp.apps.sandboxOrigin auf eine dedizierte öffentliche Origin, die zum Sandbox-Listener geleitet wird.",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchRequiresAdmin: "Für den Branch-Wechsel ist Operator-Admin-Zugriff erforderlich.",
