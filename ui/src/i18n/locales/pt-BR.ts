...
export const pt_BR: TranslationMap = {
  ...
  appsPage: {
    ...
    cards: {
      ...
      wearOs: {
        title: "Wear OS",
        desc: "O app complementar para Android estende o OpenClaw ao seu relógio.",
      },
      macos: {
        title: "macOS",
        desc: "App complementar na barra de menus para o seu Gateway — notificações, aprovações e conversa rápida.",
      },
      windows: {
        title: "Windows",
        desc: "O app complementar para Windows conecta seu PC como um nó do OpenClaw.",
      },
      linux: {
        title: "Linux",
      ...
      chrome: {
        ...
        desc: "Deixe o OpenClaw controlar seu Chrome já existente — abas, páginas e formulários.",
      },
      plugins: {
  ...
  board: {
    ...
    announcement: {
      ...
      granted: "Acesso do widget permitido.",
      rejected: "Acesso do widget rejeitado.",
    },
    widget: {
      cellLabel:
      ...
      appStaleTitle: "Este aplicativo fixado está desatualizado",
  ...
  chat: {
    ...
    composer: {
      ...
      dictationDisconnected: "O ditado parou porque o Gateway se desconectou.",
