...
export const es: TranslationMap = {
  ...
  configView: {
    ...
    sidebarPrefs: {
      ...
      liveActivity: "Mostrar actividad del agente en tiempo real en la barra lateral",
      liveActivityHint:
        "Muestra la última actividad del asistente o de las herramientas bajo las sesiones en curso.",
    },
    connection: {
      title: "Conexión",
      gateway: "Gateway",
  ...
  profilePage: {
    ...
    identity: {
      ...
      openSettings: "Abrir configuración de identidad para {name}",
      avatarErrors: {
  ...
  board: {
    ...
    widget: {
      cellLabel:
        "Widget del panel: {title}. Usa las teclas de flecha para navegar. Mantén Alt y pulsa una flecha para moverlo.",
      ...
      appLoading: "Restaurando aplicación…",
      ...
      sandboxOriginRequired:
        "La autorización del widget falló tras varios intentos de actualización. Si el gateway se ejecuta detrás de un proxy inverso o túnel que no enruta el puerto del entorno aislado del widget, establece mcp.apps.sandboxOrigin en un origen público dedicado enrutado al listener del entorno aislado.",
  ...
  chat: {
    ...
    composer: {
      ...
      holdToRecordSettingDescription:
        "Mantén pulsado el botón del micrófono del redactor, habla y luego suéltalo para insertar texto sin enviarlo.",
    ...
    toolCards: {
      ...
      widgetExportFailed: "Falló la exportación del widget. Inténtalo de nuevo.",
