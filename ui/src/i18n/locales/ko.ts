...
export const ko: TranslationMap = {
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeHint: "이 Mac에서는 OpenClaw 앱이 알림을 기본 방식으로 표시합니다.",
  ...
  custodian: {
    ...
    history: {
      button: "기록",
      title: "최근 변경 사항",
      description: "이 시스템에서 변경된 내용, 최신순으로 표시됩니다.",
    ...
    nudge: {
      ...
      channelDisconnected: "{channel} 연결이 방금 끊겼습니다 — 무슨 일이 있었는지 물어보세요",
  ...
  labsPage: {
    ...
    codeMode: {
      title: "Code Mode",
      description:
        "에이전트가 컴팩트한 샌드박스 JavaScript 워크플로에서 도구를 결합할 수 있습니다.",
    },
    swarm: {
      title: "Swarm",
      description: "Code Mode가 여러 서브에이전트 그룹을 병렬로 오케스트레이션할 수 있습니다.",
  ...
  appsPage: {
    ...
    heroTagline:
      "휴대폰, 워치, 데스크톱, 브라우저를 위한 컴패니언 앱과 에이전트의 기능을 확장하는 플러그인까지.",
    sectionMobile: "휴대폰에서",
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "iOS에서 OpenClaw로 채팅, 대화, 작업 승인, 공유를 할 수 있습니다.",
      },
      android: {
        title: "Android",
      ...
      wearOs: {
        title: "Wear OS",
        desc: "Android 컴패니언으로 OpenClaw를 시계까지 확장합니다.",
      },
      macos: {
        title: "macOS",
      ...
      windows: {
        title: "Windows",
        desc: "Windows 컴패니언으로 PC를 OpenClaw 노드로 연결합니다.",
      },
      linux: {
        title: "Linux",
      ...
      chrome: {
        ...
        desc: "OpenClaw가 기존 Chrome을 제어하도록 합니다 — 탭, 페이지, 양식.",
      },
      plugins: {
  ...
  profilePage: {
    ...
    identity: {
      title: "ID",
      description: "이 게이트웨이의 내 프로필입니다.",
      loading: "내 신원 정보를 불러오는 중…",
  ...
  board: {
    ...
    widget: {
      cellLabel:
        "대시보드 위젯: {title}. 화살표 키로 이동하세요. Alt 키를 누른 채 화살표 키를 눌러 옮길 수 있습니다.",
      moveHandle: "{title} 이동",
      ...
      frameAuthorizationFailed: "반복적인 새로 고침 시도 후에도 위젯 승인에 실패했습니다.",
      sandboxOriginRequired:
        "반복적인 새로 고침 시도 후에도 위젯 승인에 실패했습니다. gateway가 위젯 샌드박스 포트를 라우팅하지 않는 리버스 프록시나 터널 뒤에서 실행되는 경우, mcp.apps.sandboxOrigin을 샌드박스 리스너로 라우팅되는 전용 공개 origin으로 설정하세요.",
      errorTitle: "이 위젯을 로드할 수 없습니다",
      errorDetail: "문제는 이 카드에 국한됩니다.",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      copied: "복사됨",
      branches: "스레드 분기",
      branchSwitchUnavailable: "에이전트가 작업 중일 때는 분기 전환을 사용할 수 없습니다.",
    ...
    board: {
      ...
      dockMenu: "채팅 독: {dock}",
      dockLeft: "채팅 왼쪽에 고정",
      dockRight: "채팅 오른쪽에 고정",
      dockBottom: "채팅 아래쪽에 고정",
      dockHidden: "채팅 숨기기",
      resizeDock: "채팅 독 크기 조정",
      reopenChat: "채팅 표시",
      defaultTab: "메인",
      mockPlaceholder: "보드 뷰 연결 · 탭 {tabs}개 · 위젯 {widgets}개",
      mockOverview: "개요",
      mockResearch: "리서치",
    ...
    composer: {
      ...
      holdToRecordSettingDescription:
        "작성기 마이크 버튼을 누른 채로 말한 다음, 떼면 전송하지 않고 텍스트를 삽입합니다.",
      ...
      dictationFinalizationTimedOut: "마지막 부분 전사가 확정되기 전에 받아쓰기가 중지되었습니다.",
