...
export const vi: TranslationMap = {
  ...
  sessionsPage: {
    hubTablistLabel: "Mục luồng hội thoại",
  },
  pluginsPage: {
  ...
  board: {
    ...
    widget: {
      ...
      sandboxOriginRequired:
        "Ủy quyền widget thất bại sau nhiều lần thử làm mới. Nếu gateway chạy sau một reverse proxy hoặc tunnel không định tuyến cổng sandbox của widget, hãy đặt mcp.apps.sandboxOrigin thành một origin công khai riêng được định tuyến đến trình lắng nghe sandbox.",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchRequiresAdmin: "Chuyển nhánh yêu cầu quyền truy cập admin của operator.",
    ...
    board: {
      ...
      defaultTab: "Chính",
      mockPlaceholder: "Khung xem bảng · {tabs} tab · {widgets} widget",
      ...
      resetDescription:
        "Ngữ cảnh cuộc trò chuyện sẽ được đặt lại. Bảng điều khiển của bạn vẫn được giữ.",
    },
    catalog: {
    ...
    messages: {
      ...
      hide: "Ẩn",
      hideConfirm: "Ẩn tin nhắn này trong trình duyệt này? Agent vẫn thấy nó.",
    ...
    composer: {
      ...
      dictationFinalizationTimedOut:
        "Đã dừng đọc chính tả trước khi bản phiên âm một phần cuối cùng có thể được hoàn tất.",
    ...
    sessionDiscussion: {
      ...
      requiresWriteAccess: "Cần có quyền ghi của người vận hành để mở cuộc thảo luận này.",
      opened: "Cuộc thảo luận phiên",
      openExternal: "Mở cuộc thảo luận trong tab mới",
      frameTitle: "Cuộc thảo luận phiên",
