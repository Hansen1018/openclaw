...
export const nl: TranslationMap = {
  ...
  sessionsView: {
    ...
    viewArchived: "Gearchiveerd bekijken",
  ...
  subtitles: {
    ...
    labs: "Experimentele agent- en toolfunctionaliteiten.",
  ...
  custodian: {
    title: "OpenClaw",
    subtitle: "Je gids voor systeeminstelling",
    ...
    sessionRestarted:
      "{error} OpenClaw is een nieuwe sessie gestart; eerdere berichten blijven beschikbaar als context.",
    ...
    nudge: {
      ...
      channelDegraded: "{channel} is verminderd — vraag me wat er is gebeurd",
  ...
  mcpPage: {
    connectorsLink: "Ontdek één-klik-connectoren op de pagina Plugins.",
    servers: "Servers",
    oauth: "OAuth",
    filtered: "Gefilterd",
  ...
  labsPage: {
    intro:
      "Labs bevat experimentele mogelijkheden die tussen releases kunnen veranderen, defect raken of verdwijnen.",
    sectionTitle: "Experimentele functies",
    sectionDescription:
      "Wijzigingen worden meteen opgeslagen en gelden voor toekomstige agent-runs.",
  ...
  board: {
    ...
    emptyHint: "Je agent kan hier widgets vastpinnen — vraag bijvoorbeeld om een statuskaart.",
    ...
    widget: {
      ...
      sandboxUnavailable: "De widget-sandboxhost is niet beschikbaar.",
      frameAuthorizationFailed: "Widgetautorisatie is mislukt na herhaalde verversingspogingen.",
      sandboxOriginRequired:
        "Widgetautorisatie is mislukt na herhaalde verversingspogingen. Als de gateway achter een reverse proxy of tunnel draait die de widget-sandboxpoort niet routeert, stel dan mcp.apps.sandboxOrigin in op een dedicated openbare oorsprong die naar de sandbox-listener wordt gerouteerd.",
  ...
  chat: {
    ...
    board: {
      ...
      defaultTab: "Hoofd",
      mockPlaceholder: "Boardweergave-naad · {tabs} tabbladen · {widgets} widgets",
      ...
      resetTitle: "Gesprek opnieuw beginnen?",
    ...
    composer: {
      ...
      dictationBrowserAudioUnsupported: "Deze browser kan geen dictaataudio opnemen op 8 kHz.",
      dictationConnecting: "Dictaat starten…",
      dictationDisconnected: "Dictaat gestopt omdat de Gateway de verbinding verbrak.",
