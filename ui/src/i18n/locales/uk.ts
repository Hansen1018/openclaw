...
export const uk: TranslationMap = {
  ...
  quickSettings: {
    ...
    personal: {
      ...
      avatarTooLarge: "Оброблений аватар усе ще занадто великий.",
  ...
  configView: {
    ...
    notifications: {
      ...
      nativeBlockedHint:
        "Сповіщення вимкнено для OpenClaw в macOS. Дозвольте їх у Системні налаштування > Сповіщення.",
    },
    appearance: {
      theme: "Тема",
    ...
    sidebarPrefs: {
      title: "Бічна панель",
      hint: "Виберіть, що відображається під час запущених сесій.",
  ...
  nav: {
    ...
    settingsGroupSecurity: "Конфіденційність та безпека",
  ...
  custodian: {
    ...
    history: {
      button: "Історія",
      title: "Останні зміни",
      description: "Що змінилося в цій системі, найновіші зверху.",
  ...
  labsPage: {
    ...
    codeMode: {
      title: "Code Mode",
      description:
        "Дозволяє агентам поєднувати інструменти в компактних ізольованих JavaScript-робочих процесах.",
    },
    swarm: {
      title: "Swarm",
  ...
  appsPage: {
    ...
    cards: {
      ios: {
        title: "iPhone",
        desc: "Спілкуйтеся, розмовляйте, погоджуйте дії та діліться в OpenClaw з iOS.",
      },
      android: {
        title: "Android",
  ...
  profilePage: {
    ...
    identity: {
      ...
      avatarErrors: {
        ...
        tooLarge: "Оброблений аватар перевищує 512 КБ.",
      },
    },
  },
  tasksPage: {
  ...
  board: {
    ...
    widget: {
      ...
      appLoading: "Відновлення додатка…",
      appStaleTitle: "Цей закріплений додаток застарів",
      appStaleDetail: "Його сервер, ресурс або джерело транскрипту більше недоступні.",
      retry: "Повторити",
      ...
      sandboxOriginRequired:
        "Не вдалося авторизувати віджет після повторних спроб оновлення. Якщо gateway працює за реверс-проксі чи тунелем, який не маршрутизує порт пісочниці віджета, встановіть mcp.apps.sandboxOrigin на окреме публічне джерело, що маршрутизується до слухача пісочниці.",
  ...
  chat: {
    ...
    messages: {
      ...
      hide: "Приховати",
      hideConfirm: "Приховати це повідомлення в цьому браузері? Агент його все одно бачитиме.",
      ...
      rewindUnavailable: "Перемотка недоступна, поки агент працює",
    ...
    composer: {
      ...
      selectedCameraUnavailable:
        "Вибрана камера недоступна. Оберіть іншу камеру або системну за замовчуванням.",
