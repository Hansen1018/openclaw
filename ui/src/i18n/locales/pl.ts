...
export const pl: TranslationMap = {
  ...
  quickSettings: {
    ...
    personal: {
      ...
      profileHint: "JPEG, PNG lub WebP. Obrazy są przycinane centralnie i skalowane do 512 px.",
  ...
  configView: {
    ...
    sidebarPrefs: {
      title: "Pasek boczny",
      hint: "Wybierz, co ma się pojawiać, gdy sesje są uruchomione.",
      liveActivity: "Pokazuj aktywność agenta na żywo w pasku bocznym",
      liveActivityHint:
        "Pokazuj najnowszą aktywność asystenta lub narzędzi pod uruchomionymi sesjami.",
    },
    connection: {
      title: "Połączenie",
      gateway: "Gateway",
  ...
  subtitles: {
    ...
    custodian: "Konfiguracja i konserwacja systemu.",
  ...
  custodian: {
    ...
    subtitleCaretaker: "Konfiguracja i konserwacja systemu.",
  ...
  mcpServers: {
    ...
    targetInvalid: "Wprowadź URL dla transportów HTTP lub prawidłowy wiersz poleceń dla stdio.",
  ...
  mcpPage: {
    connectorsLink: "Odkryj konektory dostępne jednym kliknięciem na stronie Plugins.",
    servers: "Serwery",
    oauth: "OAuth",
    filtered: "Filtrowane",
  ...
  board: {
    ...
    emptyHint: "Twój agent może przypiąć tu widżety — spróbuj poprosić o kartę statusu.",
    ...
    widget: {
      cellLabel:
        "Widget pulpitu: {title}. Użyj klawiszy strzałek, aby nawigować. Przytrzymaj Alt i naciśnij klawisz strzałki, aby go przenieść.",
      ...
      rejectedDetail: "Ten widżet pozostaje nieaktywny do czasu jego usunięcia lub zastąpienia.",
      appLoading: "Przywracanie aplikacji…",
      appStaleTitle: "Ta przypięta aplikacja jest nieaktualna",
      appStaleDetail: "Jej serwer, zasób lub transkrypcja źródłowa nie jest już dostępna.",
      retry: "Ponów",
      ...
      sandboxOriginRequired:
        "Autoryzacja widżetu nie powiodła się po wielokrotnych próbach odświeżenia. Jeśli gateway działa za reverse proxy lub tunelem, który nie kieruje portu piaskownicy widżetu, ustaw mcp.apps.sandboxOrigin na dedykowane publiczne źródło kierowane do nasłuchu piaskownicy.",
  ...
  chat: {
    ...
    board: {
      ...
      defaultTab: "Główny",
      mockPlaceholder: "Podgląd widoku tablicy · {tabs} kart · {widgets} widżetów",
      ...
      resetDescription: "Kontekst konwersacji zostanie zresetowany. Twój panel pozostanie.",
    },
    catalog: {
    ...
    composer: {
      ...
      dictationAudioUnsupported: "Gateway zwrócił nieobsługiwany format audio dyktowania.",
      dictationBrowserAudioUnsupported:
        "Ta przeglądarka nie może rejestrować audio dyktowania z częstotliwością 8 kHz.",
