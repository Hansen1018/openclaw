...
export const fa: TranslationMap = {
  ...
  channels: {
    ...
    whatsapp: {
      ...
      loggedOut: "خارج شدید.",
      logoutNotCleared:
        "هیچ نشست ذخیره‌شده‌ای از WhatsApp پاک نشد. ممکن است از قبل موجود نباشد یا دایرکتوری احراز هویت آن نیاز به پاک‌سازی دستی داشته باشد.",
    },
  ...
  custodian: {
    ...
    history: {
      button: "تاریخچه",
      title: "تغییرات اخیر",
      description: "چه چیزی در این سیستم تغییر کرد، از جدیدترین به قدیمی‌تر.",
    ...
    nudge: {
      configReload: "بارگیری مجدد پیکربندی متوقف شد — از من بپرسید چه اتفاقی افتاد",
      ...
      channelDegraded: "{channel} افت کرده است — از من بپرسید چه اتفاقی افتاد",
  ...
  mcpServers: {
    ...
    targetInvalid: "برای transportهای HTTP یک URL یا برای stdio یک خط فرمان معتبر وارد کنید.",
  ...
  labsPage: {
    ...
    saveErrorTitle: "به‌روزرسانی ویژگی ممکن نبود",
  ...
  appsPage: {
    ...
    heroTagline:
      "اپ‌های همراه برای گوشی، ساعت، دسکتاپ و مرورگر شما — به‌علاوه پلاگین‌هایی برای گسترش کارهایی که عامل شما می‌تواند انجام دهد.",
    sectionMobile: "روی گوشی شما",
    havePhone: "اپ را از قبل دارید؟",
    ...
    cards: {
      ...
      appleWatch: {
        title: "Apple Watch",
        desc: "گفتگوهای قابل مشاهده در یک نگاه و پاسخ‌های سریع از روی مچ شما.",
      },
      wearOs: {
        title: "Wear OS",
  ...
  profilePage: {
    ...
    identity: {
      ...
      profileUnavailable: "نمایه هویت شما بارگیری نشد.",
      avatar: "آواتار",
      avatarDescription:
  ...
  board: {
    ...
    widget: {
      cellLabel:
        "ابزارک داشبورد: {title}. برای پیمایش از کلیدهای جهت‌دار استفاده کنید. برای جابجایی، کلید Alt را نگه دارید و یک کلید جهت‌دار را فشار دهید.",
      ...
      needsApprovalDetail: "این ابزارک درخواست دسترسی بیشتری داده است.",
      ...
      appStaleTitle: "این اپ سنجاق‌شده منسوخ است",
      ...
      frameAuthorizationFailed: "مجوز ویجت پس از تلاش‌های مکرر برای تازه‌سازی ناموفق بود.",
      sandboxOriginRequired:
        "مجوز ویجت پس از تلاش‌های مکرر برای تازه‌سازی ناموفق بود. اگر gateway پشت یک reverse proxy یا tunnel اجرا می‌شود که پورت sandbox ویجت را مسیریابی نمی‌کند، mcp.apps.sandboxOrigin را روی یک origin عمومی اختصاصی که به شنونده sandbox مسیریابی شده تنظیم کنید.",
      errorTitle: "این ویجت بارگذاری نشد",
      errorDetail: "این مشکل تنها به همین کارت محدود است.",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      branchSwitchUnavailable: "تعویض شاخه در حین کار کردن عامل در دسترس نیست.",
    ...
    board: {
      ...
      dockMenu: "پایگاه گفت‌وگو: {dock}",
      dockLeft: "قرارگیری گفت‌وگو در چپ",
      dockRight: "قرارگیری گفت‌وگو در راست",
      dockBottom: "قرارگیری گفت‌وگو در پایین",
      dockHidden: "پنهان کردن گفت‌وگو",
      resizeDock: "تغییر اندازه پایگاه گفت‌وگو",
      reopenChat: "نمایش گفت‌وگو",
      defaultTab: "اصلی",
      mockPlaceholder: "درز نمای بورد · {tabs} برگه · {widgets} ابزارک",
    ...
    composer: {
      ...
      cameraPageInactive: "دوربین‌ها در حالت غیرفعال بودن این صفحه در دسترس نیستند.",
      ...
      holdToRecordSettingDescription:
        "دکمه میکروفون نگارشگر را نگه دارید، صحبت کنید، سپس رها کنید تا متن بدون ارسال درج شود.",
      ...
      dictationFinalizationTimedOut: "دیکته پیش از نهایی‌شدن آخرین بخش رونویسی متوقف شد.",
